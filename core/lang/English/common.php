...
'Installed extension'		=>	'The %s official extension is installed.',
...
'Updates'					=>	'HiveBB updates:',
'Updates failed'			=>	'The latest attempt at checking for updates against the HiveBB.informer.com updates service failed. This probably just means that the service is temporarily overloaded or out of order. However, if this alert does not disappear within a day or two, you should disable the automatic check for updates and check for updates manually in the future.',
'Updates version n hf'		=>	'A newer version of HiveBB, version %s, is available for download.',
'Updates version'			=>	'A newer version of HiveBB, version %s, is available for download.',
...
'Database mismatch alert'	=>	'Your HiveBB database is meant to be used in conjunction with a newer version of the HiveBB code. This mismatch can lead to your forum not working properly. It is suggested that you upgrade your forum to the newest version of HiveBB.',
